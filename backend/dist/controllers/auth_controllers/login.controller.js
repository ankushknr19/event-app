...
const sign_jwt_utils_1 = require("./jwt_utils/sign.jwt.utils");
const login_schema_1 = require("../../database/schemas/auth_schemas/login.schema");
...
const userLoginController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, sign_jwt_utils_1.signJwtAccessToken)(res, { userId: user._id, role: user.role });
        const { refreshTokenId } = yield (0, sign_jwt_utils_1.signJwtRefreshToken)(res, user._id);
