...
const google_oauth_controller_1 = require("../controllers/auth_controllers/google_oauth.controller");
...
router.get('/google', google_oauth_controller_1.googleOAuthController);
